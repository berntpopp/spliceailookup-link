...
spliceailookup-link backend on all interfaces (0.0.0.0). It is dev/local-only and
must loopback-bind the host port; production reaches the backend only via the
router/reverse proxy. Research use only; not clinical decision support."""
